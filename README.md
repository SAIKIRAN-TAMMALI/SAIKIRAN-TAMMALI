...
### 🕵️ [Digital Forensics & Steganography — Hidden-Data Recovery from a JPG](projects/digital-forensics-steganography.md) — SilentEye + FTK
...
### 🎯 [Full-Chain Cyber Intrusion Simulation — Metasploit · Ngrok · Malware Analysis](projects/cyber-intrusion-simulation.md) — Kali → Windows lab
